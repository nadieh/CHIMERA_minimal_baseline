...
def process_interf0(
    ...
    location_time_to_biochemical_recurrence_for_prostate_cancer = get_file_location(
        job_pk=job["pk"],
        values=job["outputs"],
        slug="time-to-biochemical-recurrence-for-prostate-cancer",
    )

    # Secondly, read the results
    result_time_to_biochemical_recurrence_for_prostate_cancer = load_json_file(
        location=location_time_to_biochemical_recurrence_for_prostate_cancer,
    )

    # Thirdly, retrieve the input file name to match it with your ground truth
    image_name_transverse_dce_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="transverse-dce-prostate-mri",
    )
    image_name_axial_t2_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="axial-t2-prostate-mri",
    )
    image_name_axial_adc_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="axial-adc-prostate-mri",
    )
    image_name_axial_dwi_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="axial-dwi-prostate-mri",
    )
    image_name_prostatectomy_tissue_whole_slide_image = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image",
    )
    image_name_prostatectomy_tissue_mask = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-mask",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    )
    image_name_prostate_tissue_mask_for_axial_t2_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-axial-t2-prostate-mri",
    )
    image_name_prostate_tissue_mask_for_axial_adc_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-axial-adc-prostate-mri",
    )
    image_name_prostate_tissue_mask_for_axial_dwi_prostate_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-axial-dwi-prostate-mri",
    )
    ...
    return {
        ...
        "case_id_prediction_years_to_recurrence": result_time_to_biochemical_recurrence_for_prostate_cancer
    }
...
def process_interf1(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_1 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-1",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_1_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-1-2",
    )
...
def process_interf2(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-2",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_2_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-2-2",
    )
...
def process_interf3(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_3 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-3",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_3_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-3-2",
    )
...
def process_interf4(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_4 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-4",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_4_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-4-2",
    )
...
def process_interf5(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_5 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-5",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_5_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-5-2",
    )
...
def process_interf6(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_6 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-6",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_6_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-6-2",
    )
...
def process_interf7(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_7 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-7",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_7_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-7-2",
    )

    # Fourthly, load your ground truth
    # Include your ground truth 
...
def process_interf8(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_8 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-8",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_8_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-8-2",
    )
...
def process_interf9(
    ...
    image_name_prostatectomy_tissue_whole_slide_image_9 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-9",
    )
    image_name_prostate_tissue_mask_for_transverse_dce_mri = get_image_name(
        values=job["inputs"],
        slug="prostate-tissue-mask-for-transverse-dce-mri",
    ...
    image_name_prostatectomy_tissue_whole_slide_image_9_2 = get_image_name(
        values=job["inputs"],
        slug="prostatectomy-tissue-whole-slide-image-9-2",
    )
